...
function checkAnswers(quizData) {
    ...
    resultContainer.innerHTML = `You scored ${score} out of ${quizData.length} (${percentage}%)<br><br>`;
    ...
    fetch('save_score.php', {
        ...
        body: `course=${encodeURIComponent(currentSubject)}&score=${score}&total=${quizData.length}`
    });
